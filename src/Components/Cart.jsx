      ...
      <div className="content flex-grow-1">
        ...
        {cart.length === 0 ? (
          <div className="text-center mt-5 pt-5" data-aos="fade-up">
            ...
            <Link
              to="/products"
              className="btn btn-filter mt-3 d-inline-flex align-items-center gap-2 mx-auto"
            >
          ...
          <>
            ...
            >
              <Link
                to="/products"
                className="btn btn-filter fw-bolder d-flex align-items-center justify-content-center gap-2"
              >
                <FaShoppingBag /> Continue Shopping
              </Link>
              <button
                onClick={() => dispatch(clearCart())}
                className="btn btn-remove fw-bolder d-flex align-items-center justify-content-center gap-2"
              >
                <FaTrash /> Clear Cart
              </button>
            </div>
                    ...
                    <tr key={item.id} data-aos-delay={index * 100}>
                      ...
                      <td>
                        <button
                          ...
                          className="btn btn-sm btn-remove d-flex align-items-center gap-2"
                        >
                          <FaTrash /> Delete
                        </button>
                      </td>
